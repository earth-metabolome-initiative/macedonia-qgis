...
DEFAULT_SPECIES = Path("data/inaturalist/macedonia_species_observations_resolved.csv")
DEFAULT_HIGHER_TAXA = Path("data/inaturalist/macedonia_higher_taxa_resolved.csv")
